    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/kategori/elektronik');?>" class="nav-link">
             <i class="fas fa-tv"></i>
              <p>
                ELEKTRONIK
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/kategori/hp');?>" class="nav-link">
             ...
             <li class="nav-item">
            <a href="<?php echo base_url('index.php/kategori/kamera');?>" class="nav-link">
             ...
             <li class="nav-item">
            <a href="<?php echo base_url('index.php/kategori/aksesoris');?>" class="nav-link">
